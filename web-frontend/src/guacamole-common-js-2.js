 ...
 *     be added.
 */
Guacamole.HTTPTunnel = function(tunnelURL, nodeId, crossDomain, extraTunnelHeaders) {
    ...
    var TUNNEL_CONNECT = tunnelURL + '/node-connection?node_id=' + nodeId;
    var TUNNEL_READ    = tunnelURL + "/tunnel?read:";
    var TUNNEL_WRITE   = tunnelURL + "/tunnel?write:";
    ...
    this.connect = function(data) {
        ...
        connect_xmlhttprequest.open("GET", TUNNEL_CONNECT, true);
